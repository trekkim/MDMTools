...
//                });
    ...
    $("#add_button").click(function(e){
        $.ajax({
            ...
            data: {
                ...
                'posilamvybranyregion': $("input[name='tlacitko']:checked").val(),
                'csrfmiddlewaretoken': $("[name=csrfmiddlewaretoken]").val()
    ...
    //          async: true,
    //          data: { 
    //              'posilamtlacitkoregionu': $('#tlacitko').serialize(),
    //              'radioValue': $("input[name='tlacitko']:checked").val(),
...
$(".sync_fleet_button").click(function (e) {
        event.preventDefault();
        $.ajax({
            type: "POST",
            url: "/regional_fleet",
            ...
            data: {
                'csrfmiddlewaretoken': $("[name=csrfmiddlewaretoken]").val(),
                'action_fleet_sync': 'sync_fleet_dev'
            }
        });
    });
