...
mobileconfig='/home/youraccount/DEP_tool/profiles/tcc_zoom.mobileconfig'
...
# Function to update enroll profile
function update_enroll_profile {
source $MICROMDM_ENV_PATH
    ...
    if [ "$udid" != "null" ]; then
        ...
        update_enroll_profile $udid $mobileconfig #$hostname $apiKey
fi
